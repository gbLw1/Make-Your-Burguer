<template>
    <div>
        ...
        <ul>
            <li v-for="(technology, index) in backend_technologies"
                v-bind:key="index"
                >
                {{ technology }}
            </li>
        ...
        <p class="teste">Para acessar meu portfólio <a v-bind:href="link_portfolio" target="_blank">basta clicar aqui</a></p>
        <Picture />
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            ...
            backend_technologies: ['JavaScript', '.NET C#', 'Python'],
